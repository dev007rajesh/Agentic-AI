...
def get_session_timeline_locations(session_info: Dict[str, Any]) -> List[str]:
    ...
    Assumes session_info contains a 'timeline' key with list of location names.
    """
...
session_timeline_agent = LlmAgent(
...
google_maps_api_key = "AIzaSyAGByREmxbi5e6NYSg2vkr7gDYCF44ANak"
# https://api.openweathermap.org/data/2.5/weather?lat=12.9716&lon=77.5946&appid=f213ab1c1ad4130a7dd75bb9d89283dc
openweather_api_key = "f213ab1c1ad4130a7dd75bb9d89283dc"
updates = get_traffic_and_weather_updates(session_info, google_maps_api_key, openweather_api_key)
print(updates)
